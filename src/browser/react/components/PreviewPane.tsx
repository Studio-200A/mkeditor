...
export const PreviewPane: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    settingsProvider?.applyPreviewFontSizes();
  ...
  React.useEffect(() => {
    ...
    settings.previewTextFontSize,
    settings.previewCodeFontSize,
    settingsProvider,
  ]);
  ...
  React.useEffect(() => {
    ...
    if (!node) return;
    const visibility = settings.scrollbarVisibility;
  ...
  React.useEffect(() => {
    dispatcher.render();
  }, [activeEditablePath, treeRoot, tabs.length, dispatcher]);
  ...
  return (
    <div
      ref={previewRef}
      id="preview"
      className="flex flex-col split-preview p-3"
    >
